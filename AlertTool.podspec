#
#  Be sure to run `pod spec lint AlertTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zexin1"
  # s.authors            = { "zexin1" => "zexin1@staff.weibo.com" }
  # s.social_media_url   = "http://twitter.com/zexin1"
